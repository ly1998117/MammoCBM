...
class PrintColor:
    ...
    @staticmethod
    def char(s, front=50, color='green'):
        color_code = PrintColor.color_codes.get(color.lower(), '32')  # 默认为绿色
        new_char = "\033[0;" + color_code + ";" + str(int(front)) + "m" + s + "\033[0m"
        return new_char

    @staticmethod
    def print(s, front=50, color='green'):
        print(PrintColor.char(s, front=front, color=color))
